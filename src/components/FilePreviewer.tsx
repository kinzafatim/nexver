...
import { XIcon, FileIcon, LogFileIcon, InfoIcon, SuccessIcon, WarningIcon, ErrorIcon, DownloadIcon } from './Icons';
    ...
    <div className="h-full flex flex-col bg-white dark:bg-secondary-900 rounded-lg shadow-lg">
      <header className="flex-shrink-0 flex items-center justify-between p-4 border-b border-secondary-200 dark:border-secondary-800">
        ...
        <div className="flex items-center gap-2">
            {file.type === 'Log' && (
                <button onClick={handleDownloadLogs} className="p-2 rounded-full hover:bg-secondary-100 dark:hover:bg-secondary-700 text-secondary-600 dark:text-secondary-300" title="Download Logs">
