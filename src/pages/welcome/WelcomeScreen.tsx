  ...
  return (
    <>
      <div className="flex items-center justify-center h-screen bg-secondary-100 dark:bg-secondary-900 font-sans relative overflow-hidden">
        ...
        <div className="w-full max-w-4xl bg-white dark:bg-secondary-950 backdrop-blur-lg rounded-xl shadow-2xl overflow-hidden flex flex-col z-10 border border-secondary-200/50 dark:border-secondary-700/50">
