  ...
  return (
    <div className="flex items-center gap-1 p-1 bg-secondary-200 dark:bg-secondary-700 rounded-t-md border-b border-secondary-300 dark:border-secondary-600">
      ...
      <select 
        ...
        className="text-xs bg-transparent p-1 rounded hover:bg-secondary-300 dark:hover:bg-secondary-600 focus:outline-none"
        defaultValue="3"
      >
...
const VerificationPlanTable: React.FC<VerificationPlanTableProps> = ({ data, onViewSource, onUpdateData }) => {
