...
import { FolderIcon, FileIcon, PdfIcon, ChevronRightIcon, LogFileIcon } from './Icons';
...
const Sidebar: React.FC<SidebarProps> = ({ projectState, onFileSelect, onNavigateToTab }) => {
  ...
  return (
    <div className="w-72 bg-secondary-800 text-secondary-200 p-4 flex flex-col">
      {/* Project Title */}
